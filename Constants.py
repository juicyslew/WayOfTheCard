...
EFFECT_LIST = (DRAW_EFFECT, DEAL_EFFECT, HEAL_EFFECT, SUMMON_EFFECT, BUFF_EFFECT, SPLIT_DEAL_EFFECT, SPLIT_HEAL_EFFECT, TAUNT_EFFECT)
EFFECT_DICT = {None:"None",DRAW_EFFECT:"Draw Cards", DEAL_EFFECT:"Deal Damage", HEAL_EFFECT:"Heal", SUMMON_EFFECT:"Summon Creature", BUFF_EFFECT:"Buff Card", SPLIT_DEAL_EFFECT:"Split Damage", SPLIT_HEAL_EFFECT:"Split Heal", TAUNT_EFFECT:"Taunt"}
EFFECT_COST_DICT = {DRAW_EFFECT:-1.4, DEAL_EFFECT:1, HEAL_EFFECT:-.6, SUMMON_EFFECT:-1.3, BUFF_EFFECT:-.8, SPLIT_DEAL_EFFECT:1.2, SPLIT_HEAL_EFFECT:-1.2, TAUNT_EFFECT:-2.5}#Split Damage and heal are so high because they only work with random targets which have low values, this offsets them a bit #This converts the identity of the effect to the cost of it when generating effects
STATIC_EFFECT_LIST = (TAUNT_EFFECT,)
...
CLASS_DECK = 3
CLASS_CREATURE = 4
EFFECT_CLASS_DICT = {DRAW_EFFECT:CLASS_PLAYER, DEAL_EFFECT:CLASS_CARDS, HEAL_EFFECT:CLASS_CARDS, SUMMON_EFFECT:CLASS_PLAYER, BUFF_EFFECT:CLASS_CREATURE, SPLIT_DEAL_EFFECT:CLASS_CARDS, SPLIT_HEAL_EFFECT:CLASS_CARDS, TAUNT_EFFECT:CLASS_CARDS}
EFFECT_TRIGGER_DICT = {DRAW_EFFECT:TRIGGER_LIST, DEAL_EFFECT:TRIGGER_LIST, HEAL_EFFECT:TRIGGER_LIST, SUMMON_EFFECT:TRIGGER_LIST, BUFF_EFFECT:TRIGGER_LIST, SPLIT_DEAL_EFFECT:TRIGGER_LIST, SPLIT_HEAL_EFFECT:TRIGGER_LIST, TAUNT_EFFECT:PLAY_TRIGGER_LIST}
EFFECT_TARGET_DICT = {DRAW_EFFECT:PLAYER_TARGET_LIST, DEAL_EFFECT:TARGET_LIST, HEAL_EFFECT:TARGET_LIST, SUMMON_EFFECT:PLAYER_TARGET_LIST, BUFF_EFFECT:CREATURE_TARGET_LIST, SPLIT_DEAL_EFFECT:RANDOM_TARGET_LIST, SPLIT_HEAL_EFFECT:RANDOM_TARGET_LIST, TAUNT_EFFECT:SELF_TARGET_LIST}
