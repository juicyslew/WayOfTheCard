...
POWER_DICT = {COMMON:(1.7, .35, 1.3), UNCOMMON:(1.75,.45, 1.5), RARE:(1.8,.5,1.7), EPIC:(1.85,.575,2.0), LEGENDARY:(1.9,.7, 2.5)} #(card strength, affect spending (as opposed to stats), initial strength of card (at a cost of 0))
...
RMANA_EFFECT = 20
ADD_CARD_EFFECT = 21
ADD_CREATURE_EFFECT = 22
ADD_SPELL_EFFECT = 23


#-----------ORDER MATTERS WITH ALL OF THESE LISTS AND COST DICTIONARIES, THEY NEED TO HAVE THE SAME ORDER--------------#

EFFECT_LIST = (DRAW_EFFECT, DEAL_EFFECT, HEAL_EFFECT, SUMMON_EFFECT, BUFF_EFFECT, SPLIT_DEAL_EFFECT, SPLIT_HEAL_EFFECT, TAUNT_EFFECT, DIVINE_SHIELD_EFFECT, CHARGE_EFFECT, WINDFURY_EFFECT, DEBUFF_EFFECT, DESTROY_EFFECT, FREEZE_EFFECT, RETURN_EFFECT, REANIMATE_EFFECT, DEVOLVE_EFFECT, REVOLVE_EFFECT, EVOLVE_EFFECT, AMANA_EFFECT, RMANA_EFFECT, ADD_CARD_EFFECT, ADD_CREATURE_EFFECT, ADD_SPELL_EFFECT)
EFFECT_DICT = {None:"None",DRAW_EFFECT:"Draw Cards", DEAL_EFFECT:"Deal Damage", HEAL_EFFECT:"Heal", SUMMON_EFFECT:"Summon Creature", BUFF_EFFECT:"Buff Card", SPLIT_DEAL_EFFECT:"Split Damage", SPLIT_HEAL_EFFECT:"Split Heal", TAUNT_EFFECT:"Give Taunt", DIVINE_SHIELD_EFFECT:"Give Divine Shield", CHARGE_EFFECT:"Give Charge", WINDFURY_EFFECT:"Give Windfury", DEBUFF_EFFECT:"Give Debuff", DESTROY_EFFECT:"Destroy Creature", FREEZE_EFFECT:"Freeze Creature", RETURN_EFFECT: "Return Creature to Hand",  REANIMATE_EFFECT: "Revive Creature", DEVOLVE_EFFECT:"Devolve", REVOLVE_EFFECT:"Revolve", EVOLVE_EFFECT:"Evolve", AMANA_EFFECT:"Gain Mana Temporarily", RMANA_EFFECT:"Lose Mana Next Turn", ADD_CARD_EFFECT:"Add Cards to Hand", ADD_CREATURE_EFFECT:"Add Creatures to Hand", ADD_SPELL_EFFECT:"Add Spells to Hand"}
EFFECT_COST_DICT = {DRAW_EFFECT:-2, DEAL_EFFECT:1, HEAL_EFFECT:-.75, SUMMON_EFFECT:-1.0, BUFF_EFFECT:-1, SPLIT_DEAL_EFFECT:1, SPLIT_HEAL_EFFECT:-.75, TAUNT_EFFECT:-1.3, DIVINE_SHIELD_EFFECT:-2, CHARGE_EFFECT:-2, WINDFURY_EFFECT:-3.2, DEBUFF_EFFECT:1.35, DESTROY_EFFECT:3.5, FREEZE_EFFECT:2.25, RETURN_EFFECT:2, REANIMATE_EFFECT:-2, DEVOLVE_EFFECT:2, REVOLVE_EFFECT:.75, EVOLVE_EFFECT:-1.5, AMANA_EFFECT:-1, RMANA_EFFECT:1, ADD_CARD_EFFECT:-1, ADD_CREATURE_EFFECT:-1.3, ADD_SPELL_EFFECT:-1.5}
#Split Damage and heal are so high because they only work with random targets which have low values, this offsets them a bit #This converts the identity of the effect to the cost of it when generating effects
...
END_TURN_POS = (0, (WINDOW_HEIGHT-END_TURN_SHAPE[1])/2)
