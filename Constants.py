...
TARGET_LIST = (TARGET_RANDOM, TARGET_RANDOM_ENEMY, TARGET_RANDOM_ALLY, TARGET_ALL, TARGET_SELF, TARGET_CREATURE, TARGET_OPPONENT, TARGET_PLAYERS, TARGET_BOTH)
PLAYER_TARGET_LIST = (TARGET_BOTH, TARGET_SELF, TARGET_OPPONENT, TARGET_PLAYERS)
TARGET_DICT = {TARGET_BOTH:"Both Players", TARGET_ALL:"All", TARGET_SELF:"Own Player", TARGET_CREATURE:"Creature of choice", TARGET_OPPONENT:"Opponent", TARGET_PLAYERS:"Player of choice", TARGET_RANDOM:"Random character", TARGET_RANDOM_ENEMY:"Random Enemy", TARGET_RANDOM_ALLY:"Random Ally"}
