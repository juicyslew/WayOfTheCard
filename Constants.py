...
CARD_INITIAL_STRENGTH = 1.5 # Effective cost increase for every card
...
EFFECT_CHANCE = 1#0.75 #Chance that a given card that can have an effect has one.
DOUBLE_EFFECT_CHANCE = 1
SPELL_CHANCE = .25
EFFECT_TRY_NUM = 5
...
EFFECT_COST_DICT = {DRAW_EFFECT:-1.55, DEAL_EFFECT:1, HEAL_EFFECT:-.6, SUMMON_EFFECT:-1.2, BUFF_EFFECT:-.85, SPLIT_DEAL_EFFECT:1, SPLIT_HEAL_EFFECT:-.6, TAUNT_EFFECT:-2.5, DIVINE_SHIELD_EFFECT:-5, CHARGE_EFFECT:-4, WINDFURY_EFFECT:-5}#Split Damage and heal are so high because they only work with random targets which have low values, this offsets them a bit #This converts the identity of the effect to the cost of it when generating effects
...
TARGET_COST_DICT = {TARGET_BOTH:.5, TARGET_ALL:1.5, TARGET_OWN_PLAYER:-1, TARGET_CREATURE:1.3, TARGET_OPPONENT:1, TARGET_PLAYERS:1.1, TARGET_RANDOM:.5, TARGET_RANDOM_ENEMY:.7, TARGET_RANDOM_ALLY:-.7, TARGET_RANDOM_CREATURE:.5, TARGET_RANDOM_ENEMY_CREATURE:.7, TARGET_RANDOM_ALLY_CREATURE:-.7, TARGET_ALL_CREATURE:1.5, TARGET_THIS_CREATURE:-.9}
