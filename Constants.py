...
CARD_STRENGTH = 1.9 #Overall strength of the generated cards
...
EFFECT_COST_DICT = {DRAW_EFFECT:-1.65, DEAL_EFFECT:1, HEAL_EFFECT:-.6, SUMMON_EFFECT:-1.3, BUFF_EFFECT:-.8, SPLIT_DEAL_EFFECT:1.2, SPLIT_HEAL_EFFECT:-1.2, TAUNT_EFFECT:-2, DIVINE_SHIELD_EFFECT:-4, CHARGE_EFFECT:-3, WINDFURY_EFFECT:-4}#Split Damage and heal are so high because they only work with random targets which have low values, this offsets them a bit #This converts the identity of the effect to the cost of it when generating effects
