...
POWER_DICT = {COMMON:(1.85, .35, 1.3), UNCOMMON:(1.85,.45, 1.5), RARE:(1.85,.5,1.7), EPIC:(1.85,.575,2.0), LEGENDARY:(1.85,.7, 2.5)} #(card strength, affect spending (as opposed to stats), initial strength of card (at a cost of 0))
...
EFFECT_COST_DICT = {DRAW_EFFECT:-1.7, DEAL_EFFECT:1, HEAL_EFFECT:-.75, SUMMON_EFFECT:-1.0, BUFF_EFFECT:-1, SPLIT_DEAL_EFFECT:1, SPLIT_HEAL_EFFECT:-.75, TAUNT_EFFECT:-1.3, DIVINE_SHIELD_EFFECT:-2, CHARGE_EFFECT:-2, WINDFURY_EFFECT:-3.2, DEBUFF_EFFECT:1.35, DESTROY_EFFECT:4.5, FREEZE_EFFECT:2.25, RETURN_EFFECT:2, REANIMATE_EFFECT:-2, DEVOLVE_EFFECT:2, REVOLVE_EFFECT:1, EVOLVE_EFFECT:-1.5, AMANA_EFFECT:-1.35, RMANA_EFFECT:1.35, ADD_CARD_EFFECT:-1, ADD_CREATURE_EFFECT:-1.5, ADD_SPELL_EFFECT:-1.5}
