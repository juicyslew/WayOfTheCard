...
blend_back = ["griffin","shaman","prophet","hydra","basilisk","satyr", "minotaur",
              ...
              "ravager","rogue","king","god","cleric","sprite","vagabond","demon","acid","angel"]
...
def genimage_dudes(adj, adj2= 'NONE', noun= "sofa",adj_s = 'NONE'):
    ...
    if adj_s != 'NONE':
        if adj_s in overlay:
            ...
            if nam3 == "ancient":
                adj_s = "ancient2"
            adj_s_i = Image.open("imagelib/"+adj_s+".jpg")
            if adj_s_i.size != (480,270):
                adj_s_i = adj_s_i.resize((480,270))
                adj_s_i.save("imagelib/"+adj_s+".jpg")
            if nam3 in overlay:
            ...
            adj_s_i = Image.open("imagelib/"+adj_s+".jpg")
            adj_s_i= adj_s_i.resize((480,270))
            final = Image.blend(final,adj_s_i,0.3)

    final.save("finimages/"+noun+adj+nam2+nam3+".jpg")
    return final
        #final.save("")
    #except:
...
if __name__ == '__main__':
    genimage_dudes("cloud",noun = "angel", adj2 = "fire", adj_s ='deadly')
